...
const RefundBooking = () => {
  ...
  const handleExport = () => {
    ...
    link.setAttribute(
      "download",
      `refund_bookings_${dayjs().format("YYYY-MM-DD_HH-mm")}.csv`
    );
