...
const SeatTransfer = () => {
    ...
    const handleSearch = () => {
        ...
        setBookingDetails({
            ...
            PayRefNo: "PAY123",
            CardSuffixNo: "4567",
            BookedDateTime: "2024-12-30 10:30 AM"
        });
    };
                                    ...
                                    <Grid container spacing={3}>
                                        ...
                                        <Grid item xs={12} md={6}>
                                            <TextField
                                                ...
                                                onChange={(e) => setTransferDetails({ ...transferDetails, seatCost: e.target.value })}
                                                disabled
                                            />
                                        </Grid>
                                        <Grid item xs={12} md={6}>
                                            <TextField
                                                ...
                                                onChange={(e) => setTransferDetails({ ...transferDetails, oldSeatCost: e.target.value })}
                                                disabled
                                            />
                                        </Grid>
                                        <Grid item xs={12} md={6}>
                                            <TextField
                                                ...
                                                onChange={(e) => setTransferDetails({ ...transferDetails, balanceToPay: e.target.value })}
                                                disabled
                                            />
                                        </Grid>
