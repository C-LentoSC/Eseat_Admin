...
const SeatTransfer = () => {
    ...
    const [transferDetails, setTransferDetails] = useState({
        boardingPoint: '', droppingPoint: '', newSeatNumber: '', seatCost: '', oldSeatCost: 0, balanceToPay: ''
    });
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} md={6}>
                                            <Autocomplete
                                                ...
                                                getOptionKey={o => o.id}
                                                value={transferDetails.boardingPoint?.name}
                                                onChange={(_, value) => {
                                                    setTransferDetails({...transferDetails, boardingPoint: value})
                                                }}
                                                onClose={(evt, r) => {
                                                    if (r === 'clear') setTransferDetails({
                                                        ...transferDetails, boardingPoint: ''
                                                    })
                                                }}
